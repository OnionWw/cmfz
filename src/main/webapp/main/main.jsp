                ...
                success:function(data){
                    $.each(data,function(index,first){
                        ...
                        $.each(first.children,function (index1,second) {
                            a += "<div style='height: 30px ;text-align: center;'>"
                                    +"<a style='width: 100%;' id='btn' class='easyui-linkbutton' onclick=\"addTabs('"+second.title+"','"+second.iconCls+"','"+second.url+"')\" data-options=\"iconCls:'icon-search'\">"
                                    +second.title
                                    +"</a>"
                                +"</div>"
                        })
